 ...
 * }
 */
// Last updated: 2026-03-15T13:33:06.292Z
...
export const FIGHTERS = [
  { id:1, name:"Islam Makhachev", nickname:"The Dagestani", weight:"Welterweight", org:'UFC', rank:"CHAMPION",
    ...
    history:[
      {result:'W',opponent:"Jack Della Maddalena",method:'DEC',round:5,event:"UFC 322: Della Maddalena vs. Makhachev",year:2025},
      {result:'W',opponent:"Renato Moicano",method:'SUB',round:1,event:"UFC 311: Makhachev vs. Moicano",year:2025},
      {result:'W',opponent:"Dustin Poirier",method:'SUB',round:5,event:"UFC 302: Makhachev vs. Poirier",year:2024},
      {result:'W',opponent:"Alexander Volkanovski",method:'TKO',round:1,event:"UFC 294: Makhachev vs. Volkanovski 2",year:2023},
      {result:'W',opponent:"Alexander Volkanovski",method:'DEC',round:5,event:"UFC 284: Makhachev vs. Volkanovski",year:2023},
      {result:'W',opponent:"Charles Oliveira",method:'SUB',round:2,event:"UFC 280: Oliveira vs. Makhachev",year:2022}
    ],
  ...
  { id:2, name:"Dustin Poirier", nickname:"The Diamond", weight:"Lightweight", org:'UFC', rank:"#3",
    ...
    history:[
      {result:'W',opponent:"Benoit Saint Denis",method:'TKO',round:2,event:"UFC 299: O'Malley vs. Vera 2",year:2024},
      {result:'W',opponent:"Michael Chandler",method:'SUB',round:3,event:"UFC 281: Adesanya vs. Pereira",year:2022},
      {result:'W',opponent:"Conor McGregor",method:'TKO',round:1,event:"UFC 264: Poirier vs. McGregor 3",year:2021},
      {result:'W',opponent:"Conor McGregor",method:'TKO',round:2,event:"UFC 257: Poirier vs. McGregor",year:2021},
      {result:'W',opponent:"Dan Hooker",method:'DEC',round:5,event:"UFC Fight Night: Poirier vs. Hooker",year:2020},
      {result:'W',opponent:"Max Holloway",method:'DEC',round:5,event:"UFC 236: Holloway vs. Poirier 2",year:2019}
    ],
  ...
  { id:3, name:"Dricus Du Plessis", nickname:"Stillknocks", weight:"Middleweight", org:'UFC', rank:"CHAMPION",
    ...
    history:[
      {result:'W',opponent:"Sean Strickland",method:'DEC',round:5,event:"UFC 312: Du Plessis vs. Strickland 2",year:2025},
      {result:'W',opponent:"Israel Adesanya",method:'SUB',round:4,event:"UFC 305: Du Plessis vs. Adesanya",year:2024},
      {result:'W',opponent:"Sean Strickland",method:'DEC',round:5,event:"UFC 297: Strickland vs. Du Plessis",year:2024},
      {result:'W',opponent:"Robert Whittaker",method:'TKO',round:2,event:"UFC 290: Volkanovski vs. Rodriguez",year:2023},
      {result:'W',opponent:"Derek Brunson",method:'TKO',round:2,event:"UFC 285: Jones vs. Gane",year:2023},
      {result:'W',opponent:"Darren Till",method:'SUB',round:3,event:"UFC 282: Blachowicz vs. Ankalaev",year:2022}
    ],
  ...
  { id:4, name:"Sean O'Malley", nickname:"Suga", weight:"Bantamweight", org:'UFC', rank:"#2",
    ...
    history:[
      {result:'W',opponent:"Song Yadong",method:'DEC',round:3,event:"UFC 324: Gaethje vs. Pimblett",year:2026},
      {result:'W',opponent:"Marlon Vera",method:'DEC',round:5,event:"UFC 299: O'Malley vs. Vera 2",year:2024},
      {result:'W',opponent:"Aljamain Sterling",method:'TKO',round:2,event:"UFC 292: Sterling vs. O'Malley",year:2023},
      {result:'W',opponent:"Petr Yan",method:'DEC',round:3,event:"UFC 280: Oliveira vs. Makhachev",year:2022},
      {result:'W',opponent:"Raulian Paiva",method:'TKO',round:1,event:"UFC 269: Oliveira vs. Poirier",year:2021},
      {result:'W',opponent:"Kris Moutinho",method:'TKO',round:3,event:"UFC 264: Poirier vs. McGregor 3",year:2021}
    ],
  ...
  { id:5, name:"Merab Dvalishvili", nickname:"The Machine", weight:"Bantamweight", org:'UFC', rank:"CHAMPION",
    ...
    history:[
      {result:'W',opponent:"Cory Sandhagen",method:'DEC',round:5,event:"UFC 320: Ankalaev vs. Pereira 2",year:2025},
      {result:'W',opponent:"Sean O'Malley",method:'SUB',round:3,event:"UFC 316: Dvalishvili vs. O'Malley 2",year:2025},
      {result:'W',opponent:"Umar Nurmagomedov",method:'DEC',round:5,event:"UFC 311: Makhachev vs. Moicano",year:2025},
      {result:'W',opponent:"Sean O'Malley",method:'DEC',round:5,event:"UFC 306: Riyadh Season Noche UFC",year:2024},
      {result:'W',opponent:"Henry Cejudo",method:'DEC',round:3,event:"UFC 298: Volkanovski vs. Topuria",year:2024},
      {result:'W',opponent:"Petr Yan",method:'DEC',round:5,event:"UFC Fight Night: Yan vs. Dvalishvili",year:2023}
    ],
  ...
  { id:6, name:"Paddy Pimblett", nickname:"The Baddy", weight:"Lightweight", org:'UFC', rank:"#9",
    ...
    history:[
      {result:'W',opponent:"Michael Chandler",method:'TKO',round:3,event:"UFC 314: Volkanovski vs. Lopes",year:2025},
      {result:'W',opponent:"King Green",method:'SUB',round:1,event:"UFC 304: Edwards vs. Muhammad 2",year:2024},
      {result:'W',opponent:"Tony Ferguson",method:'DEC',round:3,event:"UFC 296: Edwards vs. Covington",year:2023},
      {result:'W',opponent:"Jared Gordon",method:'DEC',round:3,event:"UFC 282: Blachowicz vs. Ankalaev",year:2022},
      {result:'W',opponent:"Jordan Leavitt",method:'SUB',round:2,event:"UFC Fight Night: Blaydes vs. Aspinall",year:2022},
      {result:'W',opponent:"Kazula Vargas",method:'SUB',round:1,event:"UFC Fight Night: Volkov vs. Aspinall",year:2022}
    ],
  ...
  { id:7, name:"Charles Oliveira", nickname:"Do Bronxs", weight:"Lightweight", org:'UFC', rank:"#2",
    ...
    history:[
      {result:'W',opponent:"Max Holloway",method:'DEC',round:5,event:"UFC 326: Holloway vs. Oliveira 2",year:2026},
      {result:'W',opponent:"Mateusz Gamrot",method:'SUB',round:2,event:"UFC Fight Night: Oliveira vs. Gamrot",year:2025},
      {result:'W',opponent:"Michael Chandler",method:'DEC',round:5,event:"UFC 309: Jones vs. Miocic",year:2024},
      {result:'W',opponent:"Beneil Dariush",method:'TKO',round:1,event:"UFC 289: Nunes vs. Aldana",year:2023},
      {result:'W',opponent:"Justin Gaethje",method:'SUB',round:1,event:"UFC 274: Oliveira vs. Gaethje",year:2022},
      {result:'W',opponent:"Dustin Poirier",method:'SUB',round:3,event:"UFC 269: Oliveira vs. Poirier",year:2021}
    ],
  ...
  { id:8, name:"Justin Gaethje", nickname:"The Highlight", weight:"Lightweight", org:'UFC', rank:"#5",
    ...
    history:[
      {result:'W',opponent:"Paddy Pimblett",method:'DEC',round:5,event:"UFC 324: Gaethje vs. Pimblett",year:2026},
      {result:'W',opponent:"Rafael Fiziev",method:'DEC',round:3,event:"UFC 313: Pereira vs. Ankalaev",year:2025},
      {result:'W',opponent:"Dustin Poirier",method:'TKO',round:2,event:"UFC 291: Poirier vs. Gaethje 2",year:2023},
      {result:'W',opponent:"Rafael Fiziev",method:'DEC',round:3,event:"UFC 286: Edwards vs. Usman 3",year:2023},
      {result:'W',opponent:"Michael Chandler",method:'DEC',round:3,event:"UFC 268: Usman vs. Covington 2",year:2021},
      {result:'W',opponent:"Tony Ferguson",method:'TKO',round:5,event:"UFC 249: Ferguson vs. Gaethje",year:2020}
    ],
  ...
  { id:9, name:"Arman Tsarukyan", nickname:"Ahalkalakets", weight:"Lightweight", org:'UFC', rank:"#1",
    ...
    history:[
      {result:'W',opponent:"Dan Hooker",method:'SUB',round:2,event:"UFC Fight Night: Tsarukyan vs. Hooker",year:2025},
      {result:'W',opponent:"Charles Oliveira",method:'DEC',round:3,event:"UFC 300: Pereira vs. Hill",year:2024},
      {result:'W',opponent:"Beneil Dariush",method:'TKO',round:1,event:"UFC Fight Night: Dariush vs. Tsarukyan",year:2023},
      {result:'W',opponent:"Joaquim Silva",method:'TKO',round:3,event:"UFC Fight Night: Vettori vs. Cannonier",year:2023},
      {result:'W',opponent:"Damir Ismagulov",method:'DEC',round:3,event:"UFC Fight Night: Cannonier vs. Strickland",year:2022},
      {result:'W',opponent:"Joel Alvarez",method:'TKO',round:2,event:"UFC Fight Night: Makhachev vs. Green",year:2022}
    ],
  ...
  { id:10, name:"Belal Muhammad", nickname:"Remember the Name", weight:"Welterweight", org:'UFC', rank:"CHAMPION",
    ...
    history:[
      {result:'W',opponent:"Leon Edwards",method:'DEC',round:5,event:"UFC 304: Edwards vs. Muhammad 2",year:2024},
      {result:'W',opponent:"Gilbert Burns",method:'DEC',round:5,event:"UFC 288: Sterling vs. Cejudo",year:2023},
      {result:'W',opponent:"Sean Brady",method:'TKO',round:2,event:"UFC 280: Oliveira vs. Makhachev",year:2022},
      {result:'W',opponent:"Vicente Luque",method:'DEC',round:5,event:"UFC Fight Night: Luque vs. Muhammad",year:2022},
      {result:'W',opponent:"Stephen Thompson",method:'DEC',round:3,event:"UFC Fight Night: Lewis vs. Daukaus",year:2021},
      {result:'W',opponent:"Demian Maia",method:'DEC',round:3,event:"UFC 263: Adesanya vs. Vettori 2",year:2021}
    ],
  ...
  { id:11, name:"Leon Edwards", nickname:"Rocky", weight:"Welterweight", org:'UFC', rank:"#1",
    ...
    history:[
      {result:'W',opponent:"Colby Covington",method:'DEC',round:5,event:"UFC 296: Edwards vs. Covington",year:2023},
      {result:'W',opponent:"Kamaru Usman",method:'DEC',round:5,event:"UFC 286: Edwards vs. Usman 3",year:2023},
      {result:'W',opponent:"Kamaru Usman",method:'TKO',round:5,event:"UFC 278: Usman vs. Edwards",year:2022},
      {result:'W',opponent:"Nate Diaz",method:'DEC',round:5,event:"UFC 263: Adesanya vs. Vettori 2",year:2021},
      {result:'W',opponent:"Rafael Dos Anjos",method:'DEC',round:5,event:"UFC Fight Night: Dos Anjos vs. Edwards",year:2019},
      {result:'W',opponent:"Gunnar Nelson",method:'DEC',round:3,event:"UFC Fight Night: Till vs. Masvidal",year:2019}
    ],
  ...
  { id:12, name:"Jack Della Maddalena", nickname:"JDM", weight:"Welterweight", org:'UFC', rank:"#3",
    ...
    history:[
      {result:'W',opponent:"Belal Muhammad",method:'DEC',round:5,event:"UFC 315: Muhammad vs. Della Maddalena",year:2025},
      {result:'W',opponent:"Gilbert Burns",method:'TKO',round:3,event:"UFC 299: O'Malley vs. Vera 2",year:2024},
      {result:'W',opponent:"Kevin Holland",method:'DEC',round:3,event:"UFC Fight Night: Grasso vs. Shevchenko 2",year:2023},
      {result:'W',opponent:"Bassil Hafez",method:'DEC',round:3,event:"UFC Fight Night: Holm vs. Bueno Silva",year:2023},
      {result:'W',opponent:"Randy Brown",method:'SUB',round:1,event:"UFC 284: Makhachev vs. Volkanovski",year:2023},
      {result:'W',opponent:"Danny Roberts",method:'TKO',round:1,event:"UFC Fight Night: Nzechukwu vs. Cutelaba",year:2022}
    ],
  ...
  { id:13, name:"Jon Jones", nickname:"Bones", weight:"Heavyweight", org:'UFC', rank:"CHAMPION",
    ...
    history:[
      {result:'W',opponent:"Stipe Miocic",method:'TKO',round:3,event:"UFC 309: Jones vs. Miocic",year:2024},
      {result:'W',opponent:"Ciryl Gane",method:'SUB',round:1,event:"UFC 285: Jones vs. Gane",year:2023},
      {result:'W',opponent:"Dominick Reyes",method:'DEC',round:5,event:"UFC 247: Jones vs. Reyes",year:2020},
      {result:'W',opponent:"Thiago Santos",method:'DEC',round:5,event:"UFC 239: Jones vs. Santos",year:2019},
      {result:'W',opponent:"Anthony Smith",method:'DEC',round:5,event:"UFC 235: Jones vs. Smith",year:2019},
      {result:'W',opponent:"Alexander Gustafsson",method:'TKO',round:3,event:"UFC 232: Jones vs. Gustafsson 2",year:2018}
    ],
  ...
  { id:14, name:"Tom Aspinall", nickname:"The Kestrel", weight:"Heavyweight", org:'UFC', rank:"#1",
    ...
    history:[
      {result:'W',opponent:"Curtis Blaydes",method:'TKO',round:1,event:"UFC 304: Edwards vs. Muhammad 2",year:2024},
      {result:'W',opponent:"Sergei Pavlovich",method:'TKO',round:1,event:"UFC 295: Prochazka vs. Pereira",year:2023},
      {result:'W',opponent:"Marcin Tybura",method:'TKO',round:1,event:"UFC Fight Night: Aspinall vs. Tybura",year:2023},
      {result:'W',opponent:"Alexander Volkov",method:'SUB',round:1,event:"UFC Fight Night: Volkov vs. Aspinall",year:2022},
      {result:'W',opponent:"Serghei Spivac",method:'TKO',round:1,event:"UFC Fight Night: Brunson vs. Till",year:2021},
      {result:'W',opponent:"Andrei Arlovski",method:'SUB',round:2,event:"UFC Fight Night: Blaydes vs. Lewis",year:2021}
    ],
