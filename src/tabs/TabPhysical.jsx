...
export const TabPhysical = ({ fighter }) => {
  return <div className="anim-fade">
    ...
    <div className="stat-cell" style={{marginBottom:20}}><div className="stat-cell-label">CAMP / GYM</div><div style={{fontSize:13,color:'var(--text)',marginTop:4}}>{fighter.camp}</div></div>
    ...
    <div className="stat-grid" style={{gridTemplateColumns:'repeat(auto-fill,minmax(150px,1fr))'}}>
      <div className="stat-cell"><div className="stat-cell-label">CHIN RATING</div><div style={{fontSize:13,fontWeight:600,color:CHIN_COLOR[fighter.chin]||'var(--text)',marginTop:4}}>{fighter.chin}</div></div>
      <div className="stat-cell"><div className="stat-cell-label">CARDIO RATING</div><div style={{fontSize:13,fontWeight:600,color:CARDIO_COLOR[fighter.cardio]||'var(--text)',marginTop:4}}>{fighter.cardio}</div></div>
